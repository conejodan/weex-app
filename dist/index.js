...
var _weexUi = __webpack_require__(49);
...
exports.default = {
    name: 'App',
    components: { WxcButton: _weexUi.WxcButton, WxcPopup: _weexUi.WxcPopup, WxcMinibar: _weexUi.WxcMinibar, WxcIcon: _weexUi.WxcIcon },
    data: function data() {
        return {
            isShow: false,
            position: "",
    ...
    methods: {
        getPosition: function getPosition() {
            ...
            console.log(_natjs2.default.geolocation);
            var geolocation = _natjs2.default.geolocation;
            if (!_natjs2.default.geolocation) {
                modal.toast({
                    message: "No Nat.geo",
                    duration: 3
                });
            ...
            geolocation.get(function (err, ret) {
                if (err) {
                    modal.toast({
                        message: err,
                        duration: 3
            ...
            geolocation.watch(function (err, ret) {
                modal.toast({
                    message: err,
                    duration: 3
                });
...
var _bindEnv = __webpack_require__(50);
...
var _wxcButton = __webpack_require__(54);
...
var _wxcLotteryRain = __webpack_require__(153);
...
var _wxcNoticebar = __webpack_require__(169);
...
var _wxcRichText = __webpack_require__(219);
...
var _wxcSimpleFlow = __webpack_require__(237);

var _wxcSimpleFlow2 = _interopRequireDefault(_wxcSimpleFlow);

var _wxcSlideNav = __webpack_require__(242);
...
var _defaultData = __webpack_require__(77);
...
var _format = __webpack_require__(96);
...
var _fullPage = __webpack_require__(120);
...
var _animate = __webpack_require__(160);
...
var _region = __webpack_require__(162);
...
exports.default = {
  components: {
    ...
    WxcRichTextLink: __webpack_require__(226),
    WxcRichTextIcon: __webpack_require__(229),
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Esta chingon esto!")]), _c('wxc-button', {
    attrs: {
      "text": "Open Popup"
    },
    on: {
    ...
    on: {
      "wxcButtonClicked": _vm.getPosition
    }
  }), _c('text', {
    staticClass: ["message"]
  }, [_vm._v(_vm._s(_vm.position))]), _c('text', {
    staticClass: ["message"]
  }, [_vm._v(_vm._s(_vm.veces))]), _c('text', {
    staticClass: ["message"]
  }, [_vm._v("????" + _vm._s(_vm.watch_position))]), _c('wxc-popup', {
    attrs: {
      "width": "500",
      "pos": "left",
      "show": _vm.isShow
